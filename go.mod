module github.com/S1nus/blobkzg

go 1.21.6

require github.com/ethereum/c-kzg-4844 v0.4.0

require github.com/celestiaorg/celestia-app v1.0.0-rc0.0.20240123162657-cd0a1cdbb2b0
...
replace github.com/tendermint/tendermint => github.com/celestiaorg/celestia-core v1.32.0-tm-v0.34.29
